...
cachelog=$(python appleLoops.py --package-set garageband --file garageband1016.plist --optional-only -c $CacheServer)
...
sourcelog=$(python appleLoops.py --package-set garageband --file garageband1016.plist --optional-only)
